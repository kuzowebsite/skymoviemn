...
const Landing = () => {
  ...
  const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_original_language=hi&region=IN`;
  ...
  return (
    <section className=" hero flex flex-col items-center justify-center text-center gap-2 py-14 px-4 sm:px-8 lg:px-16 lg:h-80 relative ">
      <div className="w-full sm:w-2/3 md:w-2/3 lg:w-1/2 flex flex-col gap-3 z-20">
        <h1 className="text-5xl sm:text-6xl  lg:text-8xl  text-teal-50 font-bold  ">
          Find Movies
        </h1>
